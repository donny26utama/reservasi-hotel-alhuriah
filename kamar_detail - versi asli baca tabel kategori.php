 					...
 					<div class="col-lg-8">
 						<div class="product__details__text">
 							...
 							<div class="shop__sidebar__tags mb-5">
 							   <a class="btn-default">AC</a>
 							   <a class="btn-default">TV</a>
 							   <a class="btn-default">Lemari</a>
 							</div>
 							...
 							<div class="product__details__cart__option"> 								
 								<a href="booking.php?id=<?php echo $d['kamar_id'] ?>" class="primary-btn">Booking Kamar ( Sisa <?= ($jumlahkamar - $kamardipesan) ?>)</a>
 							</div>
 							...
 							<div class="product__details__last__option">	
 								<ul>
 									...
 									<li><span>Kategori:</span> <?php echo $d['kategori_nama'] ?></li>
 								</ul>
 							</div>
 						</div>
 					</div>
