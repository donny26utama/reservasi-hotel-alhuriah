...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Icon
      <small>Daftar icon yang bisa digunakan</small>
    </h1>
    <ol class="breadcrumb">
          ...
          <div class="box-body">
            ...
            <div>
              ...
              <section id="web-application">
                <h4 class="page-header">Icon Umum</h4>
                ...
                <div class="row fontawesome-icon-list">
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-automobile"></i> fa-automobile</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-bank"></i> fa-bank </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-battery-0"></i> fa-battery-0</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-battery-1"></i> fa-battery-1</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-battery-2"></i> fa-battery-2</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-battery-3"></i> fa-battery-3</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-battery-4"></i> fa-battery-4</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-cab"></i> fa-cab </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-close"></i> fa-close </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-dashboard"></i> fa-dashboard</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-edit"></i> fa-edit </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-feed"></i> fa-feed </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-movie-o"></i> fa-file-movie-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-pdf-o"></i> fa-file-pdf-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-photo-o"></i> fa-file-photo-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-picture-o"></i> fa-file-picture-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-sound-o"></i> fa-file-sound-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-zip-o"></i> fa-file-zip-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-flash"></i> fa-flash </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-gear"></i> fa-gear </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-gears"></i> fa-gears </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-group"></i> fa-group </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hand-grab-o"></i> fa-hand-grab-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hand-stop-o"></i> fa-hand-stop-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hotel"></i> fa-hotel </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hourglass"></i> fa-hourglass</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hourglass-1"></i> fa-hourglass-1</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hourglass-2"></i> fa-hourglass-2</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-hourglass-3"></i> fa-hourglass-3</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-image"></i> fa-image </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-institution"></i> fa-institution</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-legal"></i> fa-legal </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-life-bouy"></i> fa-life-bouy</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-life-buoy"></i> fa-life-buoy</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-life-ring"></i> fa-life-ring</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-life-saver"></i> fa-life-saver</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-mail-forward"></i> fa-mail-forward</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-mail-reply"></i> fa-mail-reply</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-mobile-phone"></i> fa-mobile-phone</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-mortar-board"></i> fa-mortar-board</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-navicon"></i> fa-navicon</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-photo"></i> fa-photo </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-remove"></i> fa-remove</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-reorder"></i> fa-reorder</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-send"></i> fa-send </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-send-o"></i> fa-send-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-soccer-ball-o"></i> fa-soccer-ball-o</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-sort-down"></i> fa-sort-down</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-sort-up"></i> fa-sort-up</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-star-half-empty"></i> fa-star-half-empty</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-star-half-full"></i> fa-star-half-full</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-support"></i> fa-support</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-toggle-down"></i> fa-toggle-down</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-toggle-left"></i> fa-toggle-left</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-toggle-right"></i> fa-toggle-right</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-toggle-up"></i> fa-toggle-up</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-tv"></i> fa-tv</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-unsorted"></i> fa-unsorted</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-warning"></i> fa-warning</div>
              ...
              <section id="gender">
                ...
                <div class="row fontawesome-icon-list">
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-intersex"></i> fa-intersex</div>
              ...
              <section id="currency">
                ...
                <div class="row fontawesome-icon-list">
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-bitcoin"></i> fa-bitcoin</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-btc"></i> fa-btc</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-cny"></i> fa-cny </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-dollar"></i> fa-dollar</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-eur"></i> fa-eur</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-euro"></i> fa-euro </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-money"></i> fa-money</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rmb"></i> fa-rmb </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rouble"></i> fa-rouble</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rub"></i> fa-rub</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-ruble"></i> fa-ruble </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rupee"></i> fa-rupee </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-shekel"></i> fa-shekel</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-sheqel"></i> fa-sheqel</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-try"></i> fa-try</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-turkish-lira"></i> fa-turkish-lira</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-usd"></i> fa-usd</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-won"></i> fa-won </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-yen"></i> fa-yen </div>
                </div>
              </section>
              ...
              <section id="text-editor">
                ...
                <div class="row fontawesome-icon-list">
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-chain"></i> fa-chain </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-copy"></i> fa-copy </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-cut"></i> fa-cut </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-dedent"></i> fa-dedent</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-eraser"></i> fa-eraser</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file"></i> fa-file</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-o"></i> fa-file-o</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-file-text"></i> fa-file-text</div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-paste"></i> fa-paste </div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-repeat"></i> fa-repeat</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rotate-left"></i> fa-rotate-left</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-rotate-right"></i> fa-rotate-right</div>
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-save"></i> fa-save </div>
                  ...
                  <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-unlink"></i> fa-unlink</div>
                </div>
              </section>
