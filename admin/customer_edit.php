      ...
      <section class="col-lg-6">       
        <div class="box box-default">
          ...
          <div class="box-body">
            ...
            <?php 
            $id = $_GET['id'];
            $data = mysqli_query($koneksi,"select * from customer where no_ktp='$id'");
            while($d = mysqli_fetch_array($data)){
              ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" readonly disabled class="form-control" name="ktp" required="required" placeholder="Masukkan no ktp" value="<?php echo $d['no_ktp']; ?>">
                </div>
