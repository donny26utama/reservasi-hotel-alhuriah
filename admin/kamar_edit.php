              ...
              <form action="kamar_update.php" method="post" enctype="multipart/form-data">
                   ...
                   <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select name="kategori" required="required" class="form-control">
                        ...
                        <option <?php if($d['kamar_kategori'] == "superior"){echo "selected='selected'";} ?> value="superior">superior</option>
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="kamar_jumlah" required="required" placeholder="Masukkan Jumlah Kamar .." value="<?php echo $d['kamar_jumlah']; ?>">
                  </div>
                </div>
